...
<body class="fixed inset-0 w-full h-[100dvh] flex flex-col">
    ...
    <header class="h-[var(--header-h)] glass-header border-b-[3px] border-ink flex items-center justify-between px-3 md:px-8 shrink-0 z-50 relative gap-2">
        ...
        <div class="flex items-center gap-2 sm:gap-4 shrink-0">
            ...
            <div onclick="copyRoomCode(event)" class="relative flex items-center gap-2 md:gap-3 bg-white border-[2.5px] border-ink rounded-xl px-2.5 md:px-4 py-1.5 md:py-2 cursor-pointer hover:bg-pop-blue transition-all active:translate-y-1 active:shadow-none shadow-[3px_3px_0px_#000] group">
                    ...
                    <div id="results-screen" class="absolute inset-0 z-[110] hidden bg-pop-blue flex flex-col items-center justify-center p-2 sm:p-4 text-center overflow-hidden">
                        <div class="relative w-full max-w-2xl flex flex-col items-center">
                            ...
                            <div class="flex flex-col sm:flex-row gap-3 w-full max-w-md px-4">
                                <button onclick="window.location.href = APP_ROOT + 'lobby' || '/'" class="neo-btn flex-1 bg-white px-4 sm:px-8 py-3 sm:py-4 rounded-xl sm:rounded-2xl font-black uppercase tracking-widest text-sm sm:text-lg hover:bg-pop-yellow transition-all active:translate-y-1">Return to Lobby 🏠</button>
                            </div>
                        </div>
                    </div>
                </div>
